# -*- coding: utf-8 -*-
#
# colorspacious documentation build configuration file, created by
...
htmlhelp_basename = 'colorspaciousdoc'
...
latex_documents = [
  ('index', 'colorspacious.tex', u'colorspacious Documentation',
   u'Nathaniel J. Smith, Richard Futrell', 'manual'),
]
...
man_pages = [
    ('index', 'colorspacious', u'colorspacious Documentation',
     [u'Nathaniel J. Smith, Richard Futrell'], 1)
]
