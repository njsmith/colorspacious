...
cdef np.PyUFuncGenericFunction * loops = [&XYZ_to_JMh_inner]
cdef char * types = [np.NPY_DOUBLE, np.NPY_DOUBLE, np.NPY_DOUBLE,
...
XYZ_to_JMh = np.PyUFunc_FromFuncAndData(loops, data, types,
                                        1, # number of loops
                                        3, # nin
                                        3, # nout
