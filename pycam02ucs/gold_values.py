...
# Test values from http://davengrace.com/dave/cspace/
# This uses a rounded-off sRGB->XYZ matrix so has some error
...
# has accurate XYZ->sRGB and reasonable sRGB->XYZ, but errorful XYZ<->CIELAB.
#
# The calculator at
#    http://www.brucelindbloom.com/index.html?ColorCalculator.html
# has poor sRGB matrices, but accurate XYZ<->CIELAB.
# For matching conventions to ours, make sure to check "Scale XYZ" and "Scale
# Y", but not "Scale RGB".
